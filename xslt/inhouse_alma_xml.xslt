                ...
                <digitalObject>
                    ...
                    <xsl:choose>
                        <xsl:when
                            ...
                            <file><xsl:value-of
                                    select="datafield[@tag = '856']/subfield[@code = 'u'][contains(text(), 'archive.org')]/replace(., '.*/', '')"
                                />.pdf</file>
                        </xsl:when>
                        <xsl:otherwise>
                            <file>.pdf</file>
                    ...
                    <xsl:for-each select="datafield[@tag = '501']">
                    ...
                    <xsl:for-each
                        select="datafield[@tag = '910']/subfield[@code = 'a'][contains(text(), 'Tisch')]">
                        <dc:description>
                    ...
                    <xsl:choose>
                        <xsl:when test="datafield[@tag = '050']">
                            <dc:source><xsl:value-of
                                select="normalize-space(datafield[@tag = '050'])"/>
                            </dc:source>
                        </xsl:when>
                        <xsl:otherwise>
                            <dc:source><xsl:value-of
                                select="normalize-space(datafield[@tag = '090'])"/></dc:source>
                        </xsl:otherwise>
                    </xsl:choose>
                    ...
                    <xsl:for-each select="datafield[@tag = '655']/subfield[@code = 'y']">
