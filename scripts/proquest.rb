...
Dir.mkdir("zip")
#Unzip Proquest
puts "Unziping...please be patient as this may take a while."
puts
`unzip '*.zip'`
...
Dir.chdir("../xml")
`java -cp //Applications/SaxonHE9-7-0-15J/saxon9he.jar net.sf.saxon.Transform -t -s:./collection.xml -xsl:../../../../Desktop/RepoToolkit/transforms/Proquest.xslt -o:../pdf/1_ingestThis.xml`
