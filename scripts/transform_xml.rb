module Transforms
  ...
  def transform_it_inhouse
    `java -cp //Applications/SaxonHE9-7-0-15J/saxon9he.jar net.sf.saxon.Transform -t -s:inHouse.xml -xsl:../../RepoToolkit/transforms/inhouse_alma_xml.xslt -o:./ingestThis.xml`
    `java -cp //Applications/SaxonHE9-7-0-15J/saxon9he.jar net.sf.saxon.Transform -t -s:ingestThis.xml -xsl:../../RepoToolkit/transforms/subject.xslt -o:./subjects.txt`
    self
  end
  def subject_only
